...
function downloaddocumentation(year::Integer; cachedir::AbstractString = CensoBR._defaultcachedir(),
	...
	CensoBR._downloadfile(url, destination; force = force, showprogress = showprogress, description = "Downloading documentation $year")
    
    destination
end

function preparedocumentation(year::Integer; cachedir::AbstractString = CensoBR._defaultcachedir(),
    force::Bool = false, showprogress::Bool = true)
